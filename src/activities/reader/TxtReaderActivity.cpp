...
bool TxtReaderActivity::loadBook() {
  ...
  BookStats::recordOpen(txt->getPath().c_str());
  return true;
}

void TxtReaderActivity::onExit() {
  ReaderUtils::flushReadingStats(readingSessionStartMs, true, txt ? txt->getPath().c_str() : nullptr);
...
bool TxtReaderActivity::handleFormatInput() {
  ReaderUtils::flushReadingStats(readingSessionStartMs, false, txt ? txt->getPath().c_str() : nullptr);
  return false;
}
